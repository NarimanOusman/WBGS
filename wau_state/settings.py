...
NEWS_ARCHIVE_AFTER_DAYS = int(os.environ.get('NEWS_ARCHIVE_AFTER_DAYS', 90))
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'noreply@waustate.gov')

# Investment portal email settings
INVESTMENT_ADMIN_EMAIL = os.getenv('INVESTMENT_ADMIN_EMAIL', 'investment@waustate.gov')
